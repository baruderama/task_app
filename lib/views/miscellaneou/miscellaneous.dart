...
import 'package:task_app/views/miscellaneou/miscellaneousFeatures1.dart';
import 'package:task_app/views/miscellaneou/miscellaneousFeatures2.dart';
import 'package:task_app/views/miscellaneou/miscellaneousFeatures3.dart';
import 'package:task_app/views/miscellaneou/miscellaneousFeatures4.dart';
...
class _finalFeatures extends State<MiscellaneousScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PageView(
        ...
        children: [
          MiscellaneousFeatures1(),
          MiscellaneousFeatures2(),
          MiscellaneousFeatures3(),
          MiscellaneousFeatures4(),
          RaisedButton(
            ...
            onPressed: () async {
              ...
              */
              ...
              String key = await MisceleniumCrud().addMisceleniumTask(newMisce);
              print("hola");
              print(lastkey);
