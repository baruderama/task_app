...
class MiscellaneousFeatures2 extends StatefulWidget {
  @override
  _feature1 createState() => _feature1();
}

String selectedStateMiscellaneousQ2 = null;
...
class _feature1 extends State<MiscellaneousFeatures2> {
  @override
  void initState() {
    super.initState();
    todos2 = [
      Photos(
        nombreFoto: 'guardTrial1',
        foto: 'assets/images/misce/guardTrial/guardTrial1.jpg',
      ),
    ];
  }
                  ...
                  return GestureDetector(
                    ...
                    onTap: () {
                      ...
                      this.setState(() {
                        ...
                        selectedStateMiscellaneousQ2 = todos2[index].nombreFoto;
                      });
                    },
                  );
                },
...
class BringAnswerMiscellaneous2 {
  String send() {
    return selectedStateMiscellaneousQ2;
  }
}
