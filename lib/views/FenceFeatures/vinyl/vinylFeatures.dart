...
import 'package:task_app/views/FenceFeatures/vinyl/vinylFeatures1.dart';
import 'package:task_app/views/FenceFeatures/vinyl/vinylFeatures2.dart';
import 'package:task_app/views/FenceFeatures/vinyl/vinylFeatures3.dart';
import 'package:task_app/views/FenceFeatures/vinyl/vinylFeatures4.dart';
import 'package:task_app/views/FenceFeatures/vinyl/vinylFeatures5.dart';
...
class VinylFeatures extends StatefulWidget {
  @override
  _finalFeatures createState() => _finalFeatures();
}

String selectedAcceptVinyl = null;
...
SigningCharacter _characterVinyl = SigningCharacter.Normal;

class _finalFeatures extends State<VinylFeatures> {
