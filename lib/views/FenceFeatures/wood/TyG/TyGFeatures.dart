...
import 'package:task_app/views/FenceFeatures/wood/TyG/TyGFeatures1.dart';
import 'package:task_app/views/FenceFeatures/wood/TyG/TyGFeatures2.dart';
        ...
        children: [
          ...
          RaisedButton(
            ...
            onPressed: () async {
              ...
              WoodTyG newTyG = new WoodTyG("", 'tygF', BringAnswerTyG2().send(),
