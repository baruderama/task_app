...
class MontageFeatures3 extends StatefulWidget {
  @override
...
class _feature1 extends State<MontageFeatures3> {
  @override
  void initState() {
    super.initState();
    todos3.add("Image1");
              ...
              child: GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return GestureDetector(
                    ...
                    onTap: () {
                      print('presionado' + todos3[index]);
                      this.setState(() {
                        co2 = Colors.green[300];
                        selectedStateIronQ2 = todos3[index];
                      });
                    },
                  );
                },
