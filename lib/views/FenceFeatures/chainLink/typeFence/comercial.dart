...
class _feature1 extends State<Comercial> {
  @override
  void initState() {
    super.initState();
    todosFenceChain = new List<String>();
    todosFenceChain.add("Comercial: Image1");
    todosFenceChain.add("Comercial: Image2");
    todosFenceChain.add("Comercial: Image3");
    todosFenceChain.add("Comercial: Image4");
  }
