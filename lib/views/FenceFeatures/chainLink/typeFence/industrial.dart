...
class _feature1 extends State<Industrial> {
  @override
  void initState() {
    super.initState();
    todosFenceChain = new List<String>();
    todosFenceChain.add("Industrial: Image1");
    todosFenceChain.add("Industrial: Image2");
    todosFenceChain.add("Industrial: Image3");
    todosFenceChain.add("Industrial: Image4");
  }
