...
class _feature1 extends State<Residential> {
  @override
  void initState() {
    super.initState();
    todosFenceChain = new List<String>();
    todosFenceChain.add("Residential: Image1");
    todosFenceChain.add("Residential: Image2");
    todosFenceChain.add("Residential: Image3");
    todosFenceChain.add("Residential: Image4");
  }
              ...
              child: GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return GestureDetector(
                    ...
                    onTap: () {
                      print('presionado' + todosFenceChain[index]);
                      this.setState(() {
                        co2 = Colors.green[300];
                        styleTypeFence = todosFenceChain[index];
                      });
                    },
                  );
                },
