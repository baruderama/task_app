...
class IntercomFeatures1 extends StatefulWidget {
  @override
  _feature1 createState() => _feature1();
}

String selectedStateIntercomQ1 = null;
...
class _feature1 extends State<IntercomFeatures1> {
  @override
  void initState() {
    super.initState();
    todos2.add("Image1");
                  ...
                  return GestureDetector(
                    ...
                    onTap: () {
                      ...
                      this.setState(() {
                        ...
                        selectedStateIntercomQ1 = todos2[index];
                      });
                    },
                  );
                },
...
class BringAnswerIntercom1 {
  String send() {
    return selectedStateIntercomQ1;
  }
}
