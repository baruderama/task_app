...
class MontageGatesFeatures4 extends StatefulWidget {
  @override
...
class _feature1 extends State<MontageGatesFeatures4> {
  @override
  void initState() {
    super.initState();
    todos2.add("Image1");
                  ...
                  return GestureDetector(
                    ...
                    onTap: () {
                      ...
                      this.setState(() {
                        ...
                        selectedStateMontageGatesQ1 = todos2[index];
                      });
                    },
                  );
                },
...
class BringAnswerMontageGates4 {
  String send() {
