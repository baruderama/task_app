...
import 'package:task_app/views/GatesFeatures/chainLink/chainLinkGatesFeatures1.dart';
import 'package:task_app/views/GatesFeatures/chainLink/chainLinkGatesFeatures2.dart';
import 'package:task_app/views/GatesFeatures/chainLink/chainLinkGatesFeatures3.dart';
import 'package:task_app/views/GatesFeatures/chainLink/chainLinkGatesFeatures4.dart';
import 'package:task_app/views/GatesFeatures/chainLink/chainLinkGatesFeatures5.dart';
...
class ChainLinkGatesFeatures extends StatefulWidget {
  @override
  _finalFeatures createState() => _finalFeatures();
}

class _finalFeatures extends State<ChainLinkGatesFeatures> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PageView(
        ...
        children: [
          ChainLinkGatesFeatures1(),
          ChainLinkGatesFeatures2(),
          ChainLinkGatesFeatures3(),
          ChainLinkGatesFeatures4(),
          ChainLinkGatesFeatures5(),
          ...
          RaisedButton(
            ...
            onPressed: () async {
              ...
              */
              ...
              String key = await GateCrud().addChainLinkTask(newGatelink);
              print("hola");
              print(lastkey);
