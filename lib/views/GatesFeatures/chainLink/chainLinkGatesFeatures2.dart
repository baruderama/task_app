...
class ChainLinkGatesFeatures2 extends StatefulWidget {
  @override
...
class _feature1 extends State<ChainLinkGatesFeatures2> {
  @override
  void initState() {
    super.initState();
    todos2 = [
      Photos(
        nombreFoto: 'doble',
        foto:
            'assets/images/gates/chainLink/singleDouble/chain-link-fence- doble gate.jpg',
      ),
      Photos(
        nombreFoto: 'single',
        foto: 'assets/images/gates/chainLink/singleDouble/single gate.jpg',
      ),
    ];
  }
                  ...
                  return GestureDetector(
                    ...
                    onTap: () {
                      ...
                      this.setState(() {
                        ...
                        selectedStateChainLinkQ2 = todos2[index].nombreFoto;
                      });
                    },
                  );
                },
