...
class ChainLinkGatesFeatures4 extends StatefulWidget {
  @override
  _feature1 createState() => _feature1();
}

String selectedStateChainQ4 = null;
...
class _feature1 extends State<ChainLinkGatesFeatures4> {
  @override
  void initState() {
    super.initState();
    todos2 = [
                  ...
                  return GestureDetector(
                    ...
                    onTap: () {
                      ...
                      this.setState(() {
                        ...
                        selectedStateChainQ4 = todos2[index].nombreFoto;
                      });
                    },
                  );
                },
...
class BringAnswerChainLink4 {
  String send() {
    return selectedStateChainQ4;
  }
}
