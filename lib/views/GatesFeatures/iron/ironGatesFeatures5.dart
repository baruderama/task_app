...
class IronGatesFeature5 extends StatefulWidget {
  @override
  _feature1 createState() => _feature1();
}

String selectedStateIronGatesQ5 = null;
...
class _feature1 extends State<IronGatesFeature5> {
  @override
  void initState() {
    super.initState();
    todos3 = [
      Photos(
        nombreFoto: '2',
        foto: 'assets/images/gates/harbor/top arbor.JPG',
      ),
    ];
  }
...
class BringAnswerIronGates5 {
  String send() {
    return selectedStateIronGatesQ5;
  }
}
