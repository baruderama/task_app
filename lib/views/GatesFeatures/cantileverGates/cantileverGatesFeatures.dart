...
import 'package:task_app/views/GatesFeatures/cantileverGates/cantileverGatesFeatures3.dart';
import 'package:task_app/views/GatesFeatures/cantileverGates/cantileverGatesFeatures4.dart';
import 'package:task_app/views/GatesFeatures/cantileverGates/cantilverGatesFeatures2.dart';
...
class CantileverGatesFeatures extends StatefulWidget {
  @override
  _finalFeatures createState() => _finalFeatures();
}

class _finalFeatures extends State<CantileverGatesFeatures> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PageView(
        ...
        children: [
          CantileverGatesFeatures1(),
          CantileverGatesFeatures2(),
          CantileverGatesFeatures3(),
          CantileverGatesFeatures4(),
          ...
          RaisedButton(
            ...
            onPressed: () async {
              ...
              */
              ...
              String key = await GateCrud().addCantileverTask(newCantelever);
              print("hola");
              print(lastkey);
