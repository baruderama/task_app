...
class SytleCantileverGates2 extends StatefulWidget {
  @override
...
class _feature1 extends State<SytleCantileverGates2> {
  @override
  void initState() {
    super.initState();
    todosStyle = new List<String>();
    todosStyle.add("Overhead: Image1");
    todosStyle.add("Overhead: Image2");
    todosStyle.add("Overhead: Image3");
    todosStyle.add("Overhead: Image4");
  }
