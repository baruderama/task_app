...
class SytleCantileverGates extends StatefulWidget {
  @override
...
class _feature1 extends State<SytleCantileverGates> {
  @override
  void initState() {
    super.initState();
    todosStyle = new List<String>();
    todosStyle.add("CantileverRolled: Image1");
    todosStyle.add("CantileverRolled: Image2");
    todosStyle.add("CantileverRolled: Image3");
    todosStyle.add("CantileverRolled: Image4");
  }
