...
class MotorCantileverGates4 extends StatefulWidget {
  @override
...
class _feature1 extends State<MotorCantileverGates4> {
  @override
  void initState() {
    super.initState();
    todosMotor = new List<String>();
    todosMotor.add("RemoteControl: Image1");
    todosMotor.add("RemoteControl: Image2");
    todosMotor.add("RemoteControl: Image3");
    todosMotor.add("RemoteControl: Image4");
  }
