...
class MotorCantileverGates3 extends StatefulWidget {
  @override
...
class _feature1 extends State<MotorCantileverGates3> {
  @override
  void initState() {
    super.initState();
    todosMotor = new List<String>();
    todosMotor.add("KeyPads: Image1");
    todosMotor.add("KeyPads: Image2");
    todosMotor.add("KeyPads: Image3");
    todosMotor.add("KeyPads: Image4");
  }
