...
class TaskLevel2 extends StatefulWidget {
  @override
  _TaskLevel2 createState() => _TaskLevel2();
}

class _TaskLevel2 extends State<TaskLevel2> {
  @override
      ...
      child: Column(children: <Widget>[
        ...
        Container(
          ...
          child: FlatButton(
            ...
            //  ),
            child: Text("Style ", style: TextStyle(fontSize: 15)),
          ),
        ),
        SizedBox(
          height: 10,
